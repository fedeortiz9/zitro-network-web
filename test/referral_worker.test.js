...
test("renders only the exact canonical referral route without query parameters", async () => {
...
test("permanently canonicalizes the apex without losing a valid path", async () => {
  const response = await request("https://zitronetwork.com/ref/ABCD2345");
